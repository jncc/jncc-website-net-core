...
namespace JNCC.PublicWebsite.Core.BackofficeAuthenticator
{
    ...
    /// </summary>
    public class UmbracoBackofficeUserAppAuthenticator : ITwoFactorProvider
    {
        ...
        /// </summary>
        public UmbracoBackofficeUserAppAuthenticator(IUserService userService)
        {
        ...
        public Task<object> GetSetupDataAsync(Guid userOrMemberKey, string secret)
        {
            ...
            SetupCode setupInfo = twoFactorAuthenticator.GenerateSetupCode("JNCC Backoffice", user.Username, secret, false);
